...
<body>
	...
	<form:form>
		<c:forEach items="${SCHEDULE_DATA}" var="st" >
			<label>Schedule ID</label>
			<input type="text" value="${st.scheduleId}" disabled/>
			<form:input type="hidden" path="scheduleId" value="${st.scheduleId}"/><br/>
			<label>Flight ID</label>
			<form:input path="flightId" value="${st.flightId}"/><br/>
			<label>Route ID</label>
			<form:input path="routeId" value="${st.routeId}"/><br/>
			<label>Travel Duration</label>
			<form:input path="travelDuration" value="${st.travelDuration}"/><br/>
			<label>Available Days</label>
			<form:input path="availableDays" value="${st.availableDays}"/><br/>
			<label>Departure Time</label>
			<form:input path="departureTime" value="${st.departureTime}"/><br/>
